...
public class TestPlot {
  ...
  public static void main(String[] args) throws Exception {
        ...
        Table baseball = Table.read().file(UPLOAD_DIR + "baseball.csv");
 Plot.show(ScatterPlot.create("Wins vs BA", baseball, "BA", "W"));
       Figure plot = ScatterPlot.create("Wins vs BA", baseball, "BA", "W");
       System.out.println(plot.asJavascript("test_div"));
